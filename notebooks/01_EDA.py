...
num_cols = ['avg_price_usd_mwh','total_demand_mwh','renewable_share_pct','curtailment_mwh',
...
plt.tight_layout()
plt.savefig(os.path.join(BASE, "outputs/charts", "q03_corr_heatmap.png"), dpi=140)
print("Saved correlations and heatmap.")
